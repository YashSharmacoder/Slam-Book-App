...
import com.example.volleydemo.admin_pkg.admin_admin_post;
import com.example.volleydemo.admin_pkg.admin_mypost;
import com.example.volleydemo.admin_pkg.admin_upload_pdf;
import com.example.volleydemo.admin_pkg.admin_upload_pic;
import com.example.volleydemo.admin_pkg.admin_user_post;
import com.example.volleydemo.admin_pkg.new_admin;
...
public class admin_home extends AppCompatActivity {
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if(id== R.id.admin_phot) {
                    ...
                    admin_user_post f2 = new admin_user_post();
                    ...
                    admin_upload_pic f3 = new admin_upload_pic();
                    ...
                    admin_mypost f4 = new admin_mypost();
                    ...
                    admin_upload_pdf f5 = new admin_upload_pdf();
    ...
    private void user_admin() {
        admin_admin_post f1=new admin_admin_post();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Intent i1=new Intent(admin_home.this,MainActivity.class);
            startActivity(i1);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        awesome.inflate(R.menu.admin_main, menu);
        return true;
    }
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if(id==R.id.admin_add) {
            Intent i2 = new Intent(admin_home.this, new_admin.class);
            startActivity(i2);
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost(BasicSettings.getUrl() + "fetchadmin.php?username=" + username);
            ...
            Toast.makeText(context, "Reading:" + e, Toast.LENGTH_SHORT).show();
        }
        ...
        try {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        try {
                            ...
                            if (name.equalsIgnoreCase("") || address.equalsIgnoreCase("") || city.equalsIgnoreCase("") ||
                                ...
                                Toast.makeText(context, "Don't left any field empty.", Toast.LENGTH_SHORT).show();
                            } else {
            ...
            Toast.makeText(context, "JSON : " + e, Toast.LENGTH_LONG).show();
        }
        ...
        return true;
            ...
            else if(id== R.id.admin_password) {


            LayoutInflater li = LayoutInflater.from(admin_home.this);
            View view = li.inflate(R.layout.change_password, null);

            AlertDialog.Builder alertBuilder = new AlertDialog.Builder(admin_home.this);
            alertBuilder.setCancelable(true);
                ...
                public void onClick(DialogInterface dialog, int which) {
                    try {
                        ...
                        if (!newPassword.equals(confirmPassword)) {
                            Toast.makeText(admin_home.this, "Password Don't Match", Toast.LENGTH_LONG).show();
                        } else {
                            ...
                            br.close();
                            result = sb.toString();
                            Toast.makeText(admin_home.this, result, Toast.LENGTH_LONG).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
