...
import com.example.volleydemo.user_pkg.VolleyMultipartRequest;
...
public class admin_upload_pdf extends Fragment {
    ...
    private void showFileChooser() {
        ...
        intent.setType("video/*");//intent.setType("application/pdf");
    ...
    private byte[] convert_into_bytearray() {
        byte[] byteArray = null;
        try {
    ...
    private void uploadFile(String filepath) {
        ...
        /*
         Change the file php.ini to upload large file. Find following settings and set 1000M
        ...
        */
        ...
        final byte[] byteArray = convert_into_bytearray();
        ...
        if (byteArray != null) {
            ...
            VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, SERVER_URL,
                    new Response.Listener<NetworkResponse>() {
                        ...
                        public void onResponse(NetworkResponse response) {
                            try {
                                ...
                                Toast.makeText(getActivity().getApplicationContext(), res+" Size : "+byteArray.length, Toast.LENGTH_SHORT).show();
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
                ...
                public Map<String, DataPart> getByteData() {
                    ...
                    params.put("pic", new DataPart(imagename + ".mp4", finalByteArray));
                    return params;
                }
            };
